...
<div class="content pt-0">
    ...
    <div class="col-12">
			...
			<div class="d-flex flex-wrap">
				@if ($row['sbh_st']==0)
					<a href="{{ route('approval.return.sbh_approve',$kd) }}" class="btn btn-success mr-2">Approve</a>
					<a href="{{ route('approval.return.sbh_reject',$kd) }}" class="btn btn-danger">Reject</a>
				@endif
			</div>
		</div>
	</div>
