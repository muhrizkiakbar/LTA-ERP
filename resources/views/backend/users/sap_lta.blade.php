<div class="modal-dialog">
  <div class="modal-content">
    <div class="modal-header">
      <h5 class="modal-title">Update Akun SAP LTA</h5>
    </div>
    <div class="modal-body">
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-9">{!! Form::text('username_sap_lta',null,['class'=>'form-control']) !!}</div>
      </div>
      <div class="row mb-2">
        <label class="col-sm-3 col-form-label fw-bolder">Password</label>
        <div class="col-sm-9">{!! Form::text('password_sap_lta',['class'=>'form-control']) !!}</div>
      </div>
      <div class="row mb-2">
